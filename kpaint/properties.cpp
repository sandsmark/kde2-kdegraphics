...
#define SETMINSIZE(w) w->setMinimumSize(w->sizeHint())
  ...
  : QWidget(parent)
{
  ...
  setFillColourButton= new QPushButton(i18n("Set Fill Color..."), this);
  ...
  patternBox->insertItem("12%");
  patternBox->insertItem("6%");
  SETMINSIZE(patternBox);
  grid->addWidget(patternBox, 0, 1);

  //  patternBox->insertItem(i18n("Custom"));

  customPatternLabel= new QLabel(i18n("Pattern Filename:"), this);
  SETMINSIZE(customPatternLabel);
  grid->addWidget(customPatternLabel, 1, 0);

  customPatternField= new QLineEdit(this);
  SETMINSIZE(customPatternField);
  ...
  : QWidget(parent)
{
  ...
  setLineColourButton= new QPushButton(i18n("Set Line Color..."), this);
