...
// $Id: tool.h 107633 2001-07-25 15:35:16Z rich $
...
public:
  ...
  QString tip() { return tooltip; };
  virtual QPixmap pixmap() const = 0;

  bool isSpecial() const { return special; }
  void setSpecial( bool s ) { special = s; }

  /** Used by the properties dialog */
  int getPages() const { return props; }
...
protected:
  ...
  /** If true the tool will not be listed in the tool menu etc. */
  bool special;
};
