...
enum {ATEND = -1, NONE = 0, PORTRAIT, LANDSCAPE, UPSIDEDOWN, SEASCAPE, ASCEND, DESCEND, SPECIAL};
...
struct document {
    ...
    int  orientation;		        /* PORTRAIT, LANDSCAPE, UPSIDEDOWN, SEASCAPE */
    int  default_page_orientation;	/* PORTRAIT, LANDSCAPE, UPSIDEDOWN, SEASCAPE */
