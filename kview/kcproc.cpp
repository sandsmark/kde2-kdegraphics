...
* Version:  $Id: kcproc.cpp 74275 2000-12-10 16:34:13Z mkretz $
...
static inline double max( double a, double b, double c ) { return max( a, max( b, c ) ); }

static inline double min( double a, double b ) { return a < b ? a : b; }
static inline double min( double a, double b, double c ) { return min( a, min( b, c ) ); }
